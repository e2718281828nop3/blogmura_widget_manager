// @name         class WidgetManager
// @namespace    https://github.com/e2718281828nop3/
// @version      0.1
// @description  class to manage blogmura widgets
...
const WidgetManager = class WidgetManager {
    static run(url, appName){
        new WidgetManager(url, appName).run();
    }
    ...
    constructor(url, appName){
        ...
        this.parse(url);
        this.storage = StorageFactory.load(appName, this.scope);
